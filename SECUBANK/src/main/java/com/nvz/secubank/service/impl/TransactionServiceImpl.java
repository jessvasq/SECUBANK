...
//        String fromAccountMsg = String.format("SecuBank Alert: You sent: $ %s to %s. Memo: %s", transaction.getAmount(), toAccount.getUser().getEmail(), transaction.getDescription());
//        String toAccountMsg = String.format("SecuBank Alert: %s sent you: $ %s, Memo: %s", toAccount.getUser().getEmail(), transaction.getAmount(), transaction.getDescription());
//
...
public class TransactionServiceImpl implements TransactionService {
    ...
    public void processTransfer(Account fromAccount, Account toAccount, TransactionDto transactionDto) {
        ...
        //Generate notifications
        String fromAccountMsg = String.format("SecuBank Alert: you sent: %s, to %s. Memo: %s", transaction.getAmount(), toAccount.getUser().getEmail(), transaction.getDescription());
        String toAccountMsg = String.format("SecuBank Alert: %s sent you $: %s to %s. Memo: %s", fromAccount.getUser().getEmail(), transaction.getAmount(), toAccount.getAccountNumber(),transaction.getDescription());
